...
The **CICIDS2017** (Canadian Institute for Cybersecurity Intrusion Detection System 2017) dataset is a comprehensive, labeled network intrusion detection dataset created by the University of New Brunswick's Canadian Institute for Cybersecurity. This repository, maintained by Jay Pandya, provides the **improved version** with corrected ground-truth labeling, additional features, and removed corrupted entries.
...
**Jay Pandya** is an AI/ML Engineer and Data Engineer with over 4 years of experience in developing enterprise AI solutions, scalable machine learning systems, and modern data platforms. Specialized in Generative AI, LLMs, and distributed data processing, Jay maintains this repository to provide high-performance data foundations for intelligent automation and cybersecurity research.
